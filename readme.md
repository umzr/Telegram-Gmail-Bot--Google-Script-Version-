# Telegram Gmail Bot (Python Version)

Telegram Gmail Bot (Python Version): long time no updated last update: 2021-08-11  
Please goto [Google Script Version](https://github.com/umzr/Telegram-Gmail-Bot-Google-Script-Version-) 
...
2. Click `Bot_controller.py` run it
